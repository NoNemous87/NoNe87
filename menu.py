...
class Main:
    ...
    def banner():
        ...
        print(Font.Color.GREEN + text
              +
              Font.Color.WHITE + "| A COMPLETE OSINT TOOL:)      " + Font.Color.BANNER + "CODED BY NoNe87" + Font.Color.RESET + Font.Color.WHITE + "                      |\n|                                                                   |")
        print(Font.Color.WHITE + "|[+]" + Font.Color.GREEN + "VERSION:" + version +      Font.Color.WHITE +  "\t\t\tCURRENT-DATE: {}".format(Font.Color.GREEN + Date1) + 
              Font.Color.WHITE + "    |")
        print(
            Font.Color.YELLOW + "|https://www.instagram.com/nonemous87?igsh=MXZ4dWM1Z3VqNjV5Nw==" + Font.Color.WHITE + "\t\t\tDATE-FORMAT: {}".format(Font.Color.GREEN + Country + Font.Color.YELLOW) + "          \n|Email:nonemous87@gmail.com" + Font.Color.WHITE + "\t\tCLI-LANGUAGE: {}".format(Font.Color.GREEN + Lang + Font.Color.YELLOW) + "       |\n|telegram:t.me/NoNemous87                        |")
        print(Font.Color.WHITE +
              "---------------------------------------------------------------------")
    ...
    def Mobile_Banner():
        ...
        print(Font.Color.WHITE + "A COMPLETE OSINT TOOL:)      " +
              Font.Color.BANNER + "CODED BY NoNemous87" + Font.Color.RESET)
        print(Font.Color.WHITE + "\n[+]" +
              Font.Color.GREEN + "VERSION:" + version)
        print(
            Font.Color.YELLOW + "INSTAGRAM:nonemous87\nGMAIL:nonemous87@gmail.com\nTELEGRAM:@NoNemous87\nYOUTUBE:@NoNeGUIDE\nFACEBOOK:No Ne\n")
        ...
        while True:
            try:
                ...
                if (sce == 1):
                    ...
                    Searcher.NoNemous87.search(username, Mode)
